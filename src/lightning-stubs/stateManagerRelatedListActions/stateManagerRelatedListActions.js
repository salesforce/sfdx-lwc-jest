...
/**
 * Mock factory for stateManagerRelatedListActions state manager
 */
const stateManagerRelatedListActions = jest.fn(() => {
...
export default stateManagerRelatedListActions;
